...
import com.ZCQvvv777.community.service.CommentService;
...
public class DiscussPostController implements CommunityConstant {
    ...
    public String getDiscussPost(@PathVariable("discussPostId") int discussPostId, Model model, Page page) {// 实体类page会存入model
        // 帖子
